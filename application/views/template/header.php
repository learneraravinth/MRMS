...
/* 	$this->load->library ('session');
	...
	$admin_user 	  = $session_userdata['user_type'];
	$user_type = $session_user['user_type'];
	if(!empty($admin_user)){
		$login_type = $admin_user;
	}else{
                  ...
                  <!-- user login dropdown start-->
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#">
							<?php if(empty($data[0]['user_photo'])){
								$user_photo = 'img/user_unknown.jpg';
							}else{
								$user_photo = 'uploads/admin_upload/'.$data[0]['user_photo'];
							} ?>
							<img alt="" src="<?php echo base_url().$user_photo; ?>" style="width:30;height:30px;">
                          <span class="username"> <?php echo $data[0]['admin_name']; ?></span>
                          <b class="caret"></b>
						</a>
						...
						<ul class="dropdown-menu extended logout">
                          ...
                          <li>
						  <a href="<?php echo base_url('admin/logout'); ?>"><i class=" fa fa-suitcase"></i>Profile</a>
						  </li>
