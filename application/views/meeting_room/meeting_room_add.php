                          ...
                          <div class="panel-body">
                              <form class="form-horizontal tasi-form" name="meeting_form" method="post" action="<?php echo base_url();?>admin/meeting_room/save_meeting_details">
									<div class="form-group has-success">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder = "Room Name" class="form-control" id="room_name" name="room_name" value="">
                                      </div>
									</div>
									...
									<div class="form-group has-success">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" placeholder = "Seating Capacity" class="form-control" id="seat_capacity" name="seat_capacity" value="">
                                      </div>
									</div>
									...
									<div class="form-group has-warning">
                                      ...
                                      <div class="col-lg-10">
                                       <textarea id="room_description" name="room_description" placeholder="Room Descriprtion" class="form-control" cols="10" rows="4"></textarea>
                                      </div>
									</div>
						...
						<section class="panel">													<div class="panel-body">
								<form id= "amenities_form">
									<div class="form-group">
										...
										<input  class="form-control" id="amenities_name" name="amenities_name"   placeholder="Enter amenitie _name" type="text">
									</div> 
								</form>
