				...
				<div class="panel-body">
						<form class="form-horizontal tasi-form" name= "group_form"  id="group_form">
							<div class="form-group has-success">
							  ...
							  <div class="col-lg-10">
								  <input type="text" placeholder = "Enter Group Name" class="form-control" id="group_name" name="group_name" value="">
							  </div>
							</div>
							...
							<div class="col-lg-offset-2 col-lg-10">
							  <button class="btn btn-danger" onclick = "save_group()" type="button">Save</button>
